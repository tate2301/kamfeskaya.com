...
export default function WeekViewCalendar() {
  ...
  return (
    <div className="flex flex-col h-screen">
      <header className="relative z-40 flex items-center justify-between flex-none px-6 py-4 ">
        ...
        <div className="flex items-center">
          ...
          <div className="hidden md:ml-4 md:flex md:items-center">
            ...
            <button
              type="button"
              className="px-4 py-2 ml-6 text-sm font-medium text-white bg-orange-600 border border-transparent rounded-md shadow-sm hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
            >
              Add event
            </button>
          </div>
      ...
      <div
        ref={container}
        className="flex flex-col flex-auto overflow-auto bg-white border-t"
      >
        <div
          style={{ width: '165%' }}
        ...
        >
          ...
          >
            <div className="grid grid-cols-7 text-sm leading-6 text-gray-500 sm:hidden">
              ...
              >
                W{' '}
                <span className="flex items-center justify-center w-8 h-8 mt-1 font-semibold text-white bg-orange-600 rounded-full">
                  12
                </span>
              </button>
              <button
            ...
            <div className="hidden grid-cols-7 -mr-px text-sm leading-6 text-gray-500 border-r border-gray-100 divide-x divide-gray-100 sm:grid">
              ...
              <div className="flex items-center justify-center py-3">
                <span className="flex items-baseline">
                  Wed{' '}
                  <span className="ml-1.5 flex h-8 w-8 items-center justify-center rounded-full bg-orange-600 font-semibold text-white">
                    12
                  </span>
                </span>
              </div>
