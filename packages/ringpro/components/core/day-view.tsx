      ...
      <header className="relative z-20 flex items-center justify-between flex-none px-6 py-4 border-b border-gray-200">
        ...
        <div className="flex items-center">
          ...
          <div className="hidden md:ml-4 md:flex md:items-center">
            ...
            <button
              type="button"
              className="px-4 py-2 ml-6 text-sm font-medium text-white bg-orange-600 border border-transparent rounded-md shadow-sm focus:outline-none hover:bg-orange-700 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
            >
              Add event
            </button>
          </div>
          <Menu as="div" className="relative ml-6 md:hidden">
            ...
            <Transition
              ...
              leaveTo="transform opacity-0 scale-95"
            >
              <Menu.Items className="absolute right-0 mt-3 overflow-hidden origin-top-right bg-white divide-y divide-gray-100 rounded-md shadow-lg focus:outline-none w-36 ring-1 ring-black ring-opacity-5">
                <div className="py-1">
                  <Menu.Item>
                    {({ active }) => (
                      <a
      ...
      <div className="flex flex-auto overflow-hidden bg-white">
        <div ref={container} className="flex flex-col flex-auto overflow-auto">
          ...
          >
            ...
            >
              <span>W</span>
              {/* Default: "text-gray-900", Selected: "bg-gray-900 text-white", Today (Not Selected): "text-orange-600", Today (Selected): "bg-orange-600 text-white" */}
            ...
            >
              <span>T</span>
              <span className="flex items-center justify-center w-8 h-8 mt-3 text-base font-semibold text-orange-600 rounded-full">
                20
              </span>
            </button>
            <button
            ...
            <div className="grid flex-auto grid-cols-1 grid-rows-1">
              ...
              >
                ...
                >
                  <a
                    href="#"
                    className="absolute flex flex-col p-2 overflow-y-auto text-xs leading-5 rounded-lg group inset-1 bg-orange-50 hover:bg-orange-100"
                  >
