  ...
  return (
    <EcosystemLayout name="fbpixel">
      <div className="flex flex-col items-center justify-center min-h-screen px-4 py-24 text-center">
        ...
        <p className="max-w-xl pb-4 text-xl font-medium text-slate-600 dark:text-slate-200">
        ...
        <div className="flex items-center justify-center w-full gap-4 py-8">
          <div className="max-w-md mx-auto">
            <button className="w-full px-6 py-3 font-mono font-semibold border-2 rounded-full dark:bg-gray-700 dark:text-slate-100 dark:border-zinc-700 bg-gray-50 text-zinc-800 border-zinc-300">
